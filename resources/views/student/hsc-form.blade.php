        ...
        <form class="row g-3" method="post" action="/me/hsc">
            ...
            <div class="row my-5">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('hsc_college') is-invalid @enderror" id="input_college_hsc"
                        name="hsc_college" value="{{ old('hsc_college', $hscInformation->hsc_college ?? '') }}">
                    @error('hsc_college')
            ...
            <div class="row my-5">
                ...
                <div class="col-6">
                    <label for="inputMajor" class="form-label">Major<span
                            style="color:red; font-size:20px">*</span></label>
                    <input type="text" class="form-control @error('hsc_major') is-invalid @enderror" id="input_major_hsc"
                        name="hsc_major" value="{{ old('hsc_major', $hscInformation->hsc_major ?? '') }}">
                    @error('hsc_major')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
