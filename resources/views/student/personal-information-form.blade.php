...
@section('main-content')
    ...
    <div class="container">
        ...
        <div class="card mb-a8 p-10">
            <h1>Personal form</h1>
        <form method="post" action="/me/personal-information">
            ...
            <div class="row mb-4">
                <div class="col-4">
                    ...
                    <input type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" id="mobile"
                        value="{{ old('mobile', $personalInformation->mobile ?? '') }}">
                    @error('mobile')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-4">
                    ...
                    <input type="text" class="form-control  @error('phone') is-invalid @enderror" name="phone" id="phone"
                        value="{{ old('phone', $personalInformation->phone ?? '') }}">
                    @error('phone')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row mb-4">
                <div class="col-4">
                    ...
                    <input type="text" class="form-control  @error('skype') is-invalid @enderror" name="skype" id="skype"
                        value="{{ old('skype', $personalInformation->skype ?? '') }}">
                    @error('skype')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-4">
                    ...
                    <input type="text" class="form-control  @error('other') is-invalid @enderror" name="other" id="other"
                        value="{{ old('other', $personalInformation->other ?? '') }}">
                    @error('other')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row mb-4">
                <div class="col-6">
                    ...
                    @enderror
                    <small id="emailHelp" class="form-text text-muted">We'll never share your passport Number with anyone
                        else.
                    </small>
                </div>
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control @error('nationality') is-invalid @enderror" name="nationality"
                        id="nationality" value="{{ old('nationality', $personalInformation->nationality ?? '') }}">
                    @error('nationality')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <label for="gender" name="gender" class="form-label @error('gender') is-invalid @enderror" id="gender"
                        value="{{ old('gender', $personalInformation->gender ?? '') }}">Gender : <span
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <label for="other" class="form-label">Relationship status<span style="color: red">*</span> </label>
