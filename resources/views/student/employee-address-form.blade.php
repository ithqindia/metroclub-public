        ...
        <div class="container Permanent_address mb-5">
            ...
            @endisset --}}
                ...
                <div class="row my-5">
                    ...
                    {{-- appartment --}}
                    <div class="col-lg-6 my-3">
                        <label for="apt" class="form-label">Apartment, Suite, etc<span style=color:red>*</span></label>
                ...
                <div class="row my-5">
                    <div class="col-12">
                        <label for="relationship" class="form-label">Relationship<span style=color:red>*</span></label>
        ...
        <div class="container my-5 local_address">
            <form class="row g-3 mt-5" id="local_address" method="post" action="/me/employee-address">
                ...
                <div class="row my-5">
                    ...
                    <div class="col-6">
                        <label for="city" class="form-label">City/Town<span style=color:red>*</span></label>
                        <input type="text" class="form-control  @error('local_city') is-invalid @enderror" id="local_city"
                            name="local_city" value="{{ old('local_city', $localAddress->local_city ?? '') }} ">
                        @error('local_city')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
