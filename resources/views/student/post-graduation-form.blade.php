...
@include('student.student-info-panel')
    <div class="accordion container my-3" id="accordion_container">
        <form class="row g-3" method="post" action="/me/postGraduation">
            @csrf
            @isset($postGraduationInformation)
                {{ method_field('PUT') }}
            @endisset
                ...
                <div class="row my-5">
                    ...
                    <div class="col-3">
                        ...
                        <input type="text" class="form-control @error('out_of') is-invalid @enderror" id="input_out_of"
                            name="out_of"
                            value="{{ old('post_graduation_out_of', $postGraduationInformation->out_of ?? '') }}">
                        @error('out_of')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row my-5">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control @error('major_title') is-invalid @enderror"
                            ...
                            value="{{ old('major_title', $postGraduationInformation->major_title ?? '') }}">
                        @error('major_title')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
